...
const Features = () => {
    return (
      ...
      >
        Our <span className="text-blue-600">Hi Tek </span>
         Specialists
      </h2>
      <p data-aos="fade-down" className="text-lg text-center">
      Our Electronics Products Website Specialists are a dedicated <br /> team of experts with a deep understanding of the electronics industry. They possess the technical know-how <br /> and market insights needed to create a dynamic and user-friendly website for your electronics product business.
      </p>
